...
## 🚀 从 Releases 下载 qobuz.ndp 将文件放入 Navidrome 根目录下的 plugins 插件文件夹里，并在官方网页里开启插件：
```text
/plugins/
└── qobuz.ndp
```
...
<img width="1798" height="1926" alt="1" src="https://github.com/user-attachments/assets/45d53d96-e3d4-4d64-bf68-e6b6012fd894" />
